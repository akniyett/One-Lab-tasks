...
//  HomeWork-2
//
//  Created by Akniyet Turdybay on 23.04.2022.
//
...
class CellActionProxy {
    private var actions = [String: ((SectionCellConfigurator, UIView) -> Void)]()
    
    // invoke some action and makes some notification
    func invoke(action: CellAction, cell: UIView, configurator: SectionCellConfigurator) {
